...
(lib.Sonicare_fashion_cut1_copy1_300x250px = function() {
	this.initialize(img.Sonicare_fashion_cut1_copy1_300x250px);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,301,251);


(lib.Sonicare_fashion_cut1_pic_300x250px = function() {
	this.initialize(img.Sonicare_fashion_cut1_pic_300x250px);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,301,251);


(lib.Sonicare_fashion_cut2_copy1_300x250px = function() {
	this.initialize(img.Sonicare_fashion_cut2_copy1_300x250px);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,301,251);


(lib.Sonicare_fashion_cut2_pic2_300x250px = function() {
	this.initialize(img.Sonicare_fashion_cut2_pic2_300x250px);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,301,251);


(lib.Sonicare_fashion_cut3_copy1_300x250px = function() {
	this.initialize(img.Sonicare_fashion_cut3_copy1_300x250px);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,301,251);


(lib.Sonicare_fashion_cut3_pic1_300x250px = function() {
	this.initialize(img.Sonicare_fashion_cut3_pic1_300x250px);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,301,251);


(lib.Sonicare_fashion_cut4_copy1_300x250px = function() {
	this.initialize(img.Sonicare_fashion_cut4_copy1_300x250px);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,301,251);


(lib.Sonicare_fashion_cut4_pic1_300x250px = function() {
	this.initialize(img.Sonicare_fashion_cut4_pic1_300x250px);
}).prototype = p = new cjs.Bitmap();
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.Sonicare_fashion_cut4_copy1_300x250px();
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.Sonicare_fashion_cut4_pic1_300x250px();
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.Sonicare_fashion_cut3_copy1_300x250px();
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.Sonicare_fashion_cut3_pic1_300x250px();
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.Sonicare_fashion_cut2_copy1_300x250px();
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.Sonicare_fashion_cut2_pic2_300x250px();
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.Sonicare_fashion_cut1_copy1_300x250px();
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.Sonicare_fashion_cut1_pic_300x250px();
...
// stage content:
(lib._300x250_fashion = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance_7.setTransform(106.45,125.55,1.2927,1.2927,0,0,0,150.5,125.5);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(39).to({_off:false},0).to({scaleX:1.1405,scaleY:1.1405,x:129.35,y:125.65,alpha:1},5,cjs.Ease.get(1)).to({regY:125.4,scaleX:1.001,scaleY:1.001,x:150.6,y:125.45},35).to({regY:125.5,scaleX:1,scaleY:1,x:150.5,y:125.5,alpha:0},5,cjs.Ease.get(-1)).to({_off:true},1).wait(134).to({_off:false,scaleX:1.2927,scaleY:1.2927,x:106.45,y:125.55},0).to({scaleX:1.1405,scaleY:1.1405,x:129.55,y:125.65,alpha:1},5,cjs.Ease.get(1)).to({regY:125.4,scaleX:1.001,scaleY:1.001,x:150.6,y:125.45},35).to({regY:125.5,scaleX:1,scaleY:1,x:150.5,y:125.5,alpha:0},5,cjs.Ease.get(-1)).to({_off:true},1).wait(95));
...
p.nominalBounds = new cjs.Rectangle(58.8,49,341.4,278.3);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/logo.png?1640535022752", id:"logo"},
		{src:"images/Sonicare_fashion_cut1_copy1_300x250px.png?1640535022752", id:"Sonicare_fashion_cut1_copy1_300x250px"},
		{src:"images/Sonicare_fashion_cut1_pic_300x250px.png?1640535022752", id:"Sonicare_fashion_cut1_pic_300x250px"},
		{src:"images/Sonicare_fashion_cut2_copy1_300x250px.png?1640535022752", id:"Sonicare_fashion_cut2_copy1_300x250px"},
		{src:"images/Sonicare_fashion_cut2_pic2_300x250px.png?1640535022752", id:"Sonicare_fashion_cut2_pic2_300x250px"},
		{src:"images/Sonicare_fashion_cut3_copy1_300x250px.png?1640535022752", id:"Sonicare_fashion_cut3_copy1_300x250px"},
		{src:"images/Sonicare_fashion_cut3_pic1_300x250px.png?1640535022752", id:"Sonicare_fashion_cut3_pic1_300x250px"},
		{src:"images/Sonicare_fashion_cut4_copy1_300x250px.png?1640535022752", id:"Sonicare_fashion_cut4_copy1_300x250px"},
		{src:"images/Sonicare_fashion_cut4_pic1_300x250px.png?1640535022752", id:"Sonicare_fashion_cut4_pic1_300x250px"}
	],
	preloads: []
};
